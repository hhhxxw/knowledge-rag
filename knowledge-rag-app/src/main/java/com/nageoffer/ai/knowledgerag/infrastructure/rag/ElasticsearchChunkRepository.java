...
public class ElasticsearchChunkRepository {
    ...
    public ElasticsearchChunkRepository(RagPlatformProperties ragPlatformProperties) {
        this.ragPlatformProperties = ragPlatformProperties;
        this.indexName = ragPlatformProperties.getKeywordIndexName();
    }

    @PostConstruct
    public void init() {
        this.restClient = RestClient.builder()
                .baseUrl(ragPlatformProperties.getElasticsearchUrl())
                .build();
        initIndex();
    }
    ...
    private void initIndex() {
        try {
            String analyzer = ragPlatformProperties.getKeywordAnalyzer();
            ...
            log.info("[ES] 索引 {} 创建成功, analyzer={}", indexName, analyzer);
        } catch (Exception e) {
    ...
    public void indexDocuments(List<Document> documents) {
        ...
        try {
            ...
            for (Document doc : documents) {
                Map<String, Object> action = Map.of("index", Map.of("_index", indexName, "_id", doc.getId()));
