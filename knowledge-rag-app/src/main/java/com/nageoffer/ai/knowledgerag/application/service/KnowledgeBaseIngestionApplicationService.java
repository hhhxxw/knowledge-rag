...
public class KnowledgeBaseIngestionApplicationService {
    ...
    public DocumentIngestionResponse ingest(MultipartFile file, String kb) {
        ...
        elasticsearchChunkRepository.indexDocuments(chunks);
        log.info("[Ingest] 入库完成: file={}, kb={}, chunks={}", fileName, kbName, chunks.size());
        return new DocumentIngestionResponse(fileName, kbName, chunks.size());
    }
